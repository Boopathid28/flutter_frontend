...
class MetalWiseSaleReportController extends HeaderController {
  @override
  ...
  RxList<MetalWiseSaleReport> tableData = <MetalWiseSaleReport>[].obs;
  ...
  Future getMetalWiseSaleReport() async {
    isTableLoading(true);
    ...
    final payload = MetalWiseSaleReportPayload(
      branch: branchFilter,
      fromDate:
    ...
    var response = await ReportsServices.fetchMetalWiseSalesReport(payload);
    if (response != null) {
  ...
  Future exportData(BuildContext context) async {
    ...
    var response =
        await ExportReportService.exportMetalWiseSalesReport(payload, context);
