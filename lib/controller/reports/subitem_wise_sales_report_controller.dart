...
class SubitemWiseSalesReportController extends HeaderController {
  @override
  ...
  RxList<SubitemWiseSaleReport> tableData = <SubitemWiseSaleReport>[].obs;
  ...
  Future getSubitemWiseSalesReport() async {
    isTableLoading(true);
    ...
    final payload = SubitemWiseSaleReportPayload(
      branch: branchFilter,
      fromDate:
    ...
    var response = await ReportsServices.fetchSubitemWiseSalesReport(payload);
    if (response != null) {
  ...
  Future exportData(BuildContext context) async {
    ...
    var response =
        await ExportReportService.exportSubItemWiseSalesReport(payload, context);
