...
class PurityWiseSalesReportController extends HeaderController {
  @override
  ...
  RxList<PurityWiseSaleReport> tableData = <PurityWiseSaleReport>[].obs;
  ...
  Future getPurityWiseSalesReport() async {
    isTableLoading(true);
    ...
    final payload = PurityWiseSaleReportPayload(
      branch: branchFilter,
      fromDate:
    ...
    var response = await ReportsServices.fetchPurityWiseSalesReport(payload);
    if (response != null) {
  ...
  Future exportData(BuildContext context) async {
    ...
    var response =
        await ExportReportService.exportPurityWiseSalesReport(payload, context);
