...
class ApprovalPendingReportController extends HeaderController {
  ...
  RxList<ApprovalPendingReportListData> tableData =
      <ApprovalPendingReportListData>[].obs;
  ...
  Future getApprovalPendingreport(BuildContext context) async {
    isTableLoading(true);
    ...
    FetchApprovalPendingReportListDataPayload payload =
    ...
    final Map<String, dynamic>? ordermetalwisereportList =
        await ReportsServices
            .fetchApprovalPendingReport(payload: payload);
 ...
 tableData(ordermetalwisereportList['list']);
   ...
   Future exportData(BuildContext context) async {
    ...
    final payload = FetchApprovalPendingReportListDataPayload(
        page: page.value,
            fromDate: fromDate,
            toDate: toDate,
                  search: searchController.text,
            ...
            menuId: await HomeSharedPrefs.getCurrentMenu());
    var response =
        await ExportReportService.exportApprovalPendingListReport(payload, context);
   ...
   Future exportPdfData(BuildContext context) async {
    ...
    final payload = FetchApprovalPendingReportListDataPayload(
        page: page.value,
            ...
            menuId: await HomeSharedPrefs.getCurrentMenu());
    var response =
        await ExportReportService.exportApprovalPendingListPdfReport(payload, context);
