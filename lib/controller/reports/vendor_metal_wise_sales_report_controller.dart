...
class VendorMetalWiseSalesReportController extends HeaderController {
  @override
  ...
  RxList<VendorMetalWiseSalesReport> tableData =
      <VendorMetalWiseSalesReport>[].obs;
  ...
  Future getVendorMetalWisesalesReport() async {
    isTableLoading(true);
    ...
    final payload = VendorMetalWiseSalesReportPayload(
        branch: branchFilter,
        fromDate:
        ...
        vendor: vendorFilter);
    var response =
        await ReportsServices.fetchVendorMetalWiseSalesReport(payload);
    if (response != null) {
  ...
  Future exportData(BuildContext context) async {
    ...
    final payload = VendorMetalWiseSalesReportPayload(
        ...
        toDate: toDateController.text,
        vendor: vendorFilter);
    var response = await ExportReportService.exportVendorMetalWiseSalesReport(
        payload, context);
