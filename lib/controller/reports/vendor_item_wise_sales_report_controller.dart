...
class VendorItemWiseSalesReportController extends HeaderController {
  @override
  ...
  RxList<VendorItemWiseSalesReport> tableData =
      <VendorItemWiseSalesReport>[].obs;
  ...
  Future getVendorItemWiseSalesReport() async {
    isTableLoading(true);
    ...
    final payload = VendorItemWiseSalesReportPayload(
        branch: branchFilter,
        fromDate:
        ...
        vendor: vendorFilter);
    var response =
        await ReportsServices.fetchVendorItemWiseSalesReport(payload);
    if (response != null) {
  ...
  Future exportData(BuildContext context) async {
    ...
    final payload = VendorItemWiseSalesReportPayload(
        ...
        search: searchController.text,
        vendor: vendorFilter);
    var response = await ExportReportService.exportVendorItemWiseSalesReport(
        payload, context);
