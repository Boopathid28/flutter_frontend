...
class ApprovalReceivedReportController extends HeaderController {
  ...
  RxList<ApprovalReceivedReportListData> tableData =
      <ApprovalReceivedReportListData>[].obs;
  ...
  Future getApprovalReceivedreport(BuildContext context) async {
    isTableLoading(true);
    ...
    FetchApprovalReceivedReportListDataPayload payload =
    ...
    final Map<String, dynamic>? ordermetalwisereportList =
        await ReportsServices
            .fetchApprovalReceivedReport(payload: payload);
 ...
 tableData(ordermetalwisereportList['list']);
   ...
   Future exportData(BuildContext context) async {
    ...
    final payload = FetchApprovalReceivedReportListDataPayload(
        page: page.value,
            fromDate: fromDate,
            toDate: toDate,
                  search: searchController.text,
            ...
            menuId: await HomeSharedPrefs.getCurrentMenu());
    var response =
        await ExportReportService.exportApprovalReceivedListReport(payload, context);
   ...
   Future exportPdfData(BuildContext context) async {
    ...
    final payload = FetchApprovalReceivedReportListDataPayload(
        page: page.value,
            ...
            menuId: await HomeSharedPrefs.getCurrentMenu());
    var response =
        await ExportReportService.exportApprovalReceivedListPdfReport(payload, context);
