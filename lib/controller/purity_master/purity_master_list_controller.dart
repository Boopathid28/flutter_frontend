...
class PurityMasterListController extends GetxController {
  ...
  RxList<PurityMasterListData> tableData = <PurityMasterListData>[].obs;
  ...
  FutureOr getPurityMasterList(BuildContext context) async {
    isTableLoading(true);
    ...
    FetchPurityMasterListPayload payload = FetchPurityMasterListPayload(
    ...
    final Map<String, dynamic>? userList =
        await PurityMasterService.fetchPurityMasterList(payload: payload);
