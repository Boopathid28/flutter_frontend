...
class InvoiceAdvanceFormController extends HeaderController {
  ...
  final invoiceAdvanceFormKey = GlobalKey<FormState>();
  ...
  Future CreateAdvance(BuildContext context) async {
    if (invoiceAdvanceFormKey.currentState!.validate()) {
      if (!isFormSubmit.value) {
        ...
        CreateAdvancePayload payload = CreateAdvancePayload(
            ...
            customerDetails: _invoiceController.customerDetails.value.id.toString(),
