...
class UserListController extends HeaderController {
  ...
  RxList<UserListData> tableData = <UserListData>[].obs;
  ...
  Future getUserList(BuildContext context) async {
    ...
    FetchUserListPayload payload = FetchUserListPayload(
    ...
    final Map<String, dynamic>? userList =
        await UserService.fetchUserList(payload: payload);
