...
class OldMetalPaymentController extends GetxController {
  ...
  Future getOldMetalDetails(
      ...
      RxList<OldPurchasePaymentParticularsDetails> itemsList,
    ...
    if (oldMetalSearchController.text.isNotEmpty) {
      ...
      if (isValid) {
        ...
        if (data != null) {
          itemsList.add(OldPurchasePaymentParticularsDetails(
              id: data.id.toString(),
  ...
  void onMetalChange(DropdownModel metal,String gstType) {
    selectedMetal(metal);
  ...
  Future createOldPurchase(
      BuildContext context,
      List<OldItemPaymentDetails> itemsList,
      String branch,
    ...
    if (itemsList.isNotEmpty) {
      if (!isFormSubmit.value) {
        ...
        OldPurchasePaymentPayload payload =
              ...
              AlertDialog(
                    ...
                    actions: [
                      PrimaryButton(
                          ...
                          onPressed: () {
                            Clipboard.setData(
                                ClipboardData(text: data.oldGoldBillNumber.toString()));
                            toastification.show(
                                context:
