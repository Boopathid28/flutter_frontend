...
class AprovalIssuesTagFormController extends HeaderController {
  @override
  ...
  Future getTagnumberList(String? branch) async {
    ...
    final List<TagNumberDropdownModel> tempList =
        await DropdownService.NewTagNumberDropDown(branch);
  ...
  Future getTagItemList(String? tagnumber, BuildContext context) async {
    log((_approvalIssuesFormController.itemtagParticularList
        .indexWhere((item) => item.tagNumber == tagnumber)).toString());

    if ((_approvalIssuesFormController.itemtagParticularList
      ...
      if (response != null) {
        ...
        final ItemTagdetailsList itemTagListData = ItemTagdetailsList(
            ...
            MetalDetailsName: tableData.value.MetalDetailsName,
            itemDetailsName: tableData.value.itemDetailsName,
            subItemDetailsName: tableData.value.subItemDetailsName);
        _approvalIssuesFormController.itemtagParticularList
