...
class MannualEstimationOldItemFormController extends GetxController {
  ...
  editItem(MannualExchangeDetails item) {
    itemFormMode("update");
  ...
  deleteItem(MannualExchangeDetails oldItem) {
    _mannualEstimationController.oldParticulars.removeWhere((item) => item.id == oldItem.id);
  }
  ...
  Future submitForm(BuildContext context) async {
    if (estiamtionOldPurchaseItemFormDetailsFormKey.currentState!.validate()) {
      if (itemFormMode.value == "create") {
        var uuid = Uuid();
        MannualExchangeDetails oldItemDetails = MannualExchangeDetails(
          id: uuid.v4(),
        ...
        _mannualEstimationController.oldParticulars.insert(0, oldItemDetails);
      } else {
        int index =
            _mannualEstimationController.oldParticulars.indexWhere((item) => item.id == updatingItem.value);
        ...
        _mannualEstimationController.oldParticulars[index] = oldItemDetails;
      }
