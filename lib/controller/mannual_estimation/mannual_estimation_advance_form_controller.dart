...
class MannualEstimationAdvanceFormController extends HeaderController {
    ...
    if (estimationAdvanceFormKey.currentState!.validate()) {
      if (!isFormSubmit.value) {
        ...
        CreateAdvancePayload payload = CreateAdvancePayload(
            ...
            branch: _mannualEstimationController.selectedBranch.value?.value,
            customerDetails: _mannualEstimationController.customerDetails.value.id.toString(),
