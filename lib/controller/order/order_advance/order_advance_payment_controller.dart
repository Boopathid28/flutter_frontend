...
import 'package:ausales_application/view/widgets/screen_widgets/order/order_advance_payment/order_advance_details_retrieve_form.dart';
...
class OrderAdvancePaymentController extends GetxController {
  ...
  Future getAdvanceDetails(BuildContext context, List<AdvanceDetails> itemsList,
      ...
      if (isValid) {
        ...
        if (data != null) {
          ...
          await Get.dialog(
              ...
              OrderAdvanceDetailsRetrieveForm(
                  data: data,
  ...
  void applyAdvanceDetails(
    ...
    if ((advanceRedeemAmountController.text.isNotEmpty &&
      ...
      AdvanceDetails advanceDetails = AdvanceDetails(
