...
class ManualInvoicePaylaod {
  ...
  bool? isPayment;
  bool? isIssued;
  List<ManualParticularDetails>? particularDetails;
  List<int>? exchangeDetails;
  List<int>? suspenseDetails;
  List<ManualInvoiceAdvanceDetails>? advanceDetails;
  List<ManualPaymentDenominationDetails>? paymentDenominationDetails;
  List<ChitPaymentDetails>? chitDetails;

  ManualInvoicePaylaod(
      {this.menuId,
      this.billDate,
  ...
  ManualInvoicePaylaod.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
    ...
    if (json['particular_details'] != null) {
      particularDetails = <ManualParticularDetails>[];
      json['particular_details'].forEach((v) {
        particularDetails!.add(new ManualParticularDetails.fromJson(v));
      });
    }
    exchangeDetails = json['exchange_details'].cast<int>();
    suspenseDetails = json['suspense_details'].cast<int>();
    if (json['advance_details'] != null) {
      advanceDetails = <ManualInvoiceAdvanceDetails>[];
      json['advance_details'].forEach((v) {
        advanceDetails!.add(new ManualInvoiceAdvanceDetails.fromJson(v));
      });
    }
    if (json['payment_denomination_details'] != null) {
      paymentDenominationDetails = <ManualPaymentDenominationDetails>[];
      json['advance_details'].forEach((v) {
        paymentDenominationDetails!.add(new ManualPaymentDenominationDetails.fromJson(v));
      });
    }
...
class ManualParticularDetails {
  ...
  List<ManualTagDetailStoneDetails>? stoneDetails;
  List<ManualTagDetailDiamondDetails>? diamondDetails;
  ...
  ManualParticularDetails.fromJson(Map<String, dynamic> json) {
    sNo = json['s_no'];
    tag = json['tag_number'];
    rate = json['rate'];
    minRate = json['min_rate'];
    pieces = json['pieces'];
    itemId = json['item_details'];
    itemName = json['item_details_name'];
    subItemId = json['sub_item_details'];
    ...
    if (json['stone_details'] != null) {
      stoneDetails = <ManualTagDetailStoneDetails>[];
      json['stone_details'].forEach((v) {
        stoneDetails!.add(new ManualTagDetailStoneDetails.fromJson(v));
      });
    }
    if (json['diamond_details'] != null) {
      diamondDetails = <ManualTagDetailDiamondDetails>[];
      json['diamond_details'].forEach((v) {
        diamondDetails!.add(new ManualTagDetailDiamondDetails.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['item_details'] = this.itemId;
    data['item_details_name'] = this.itemName;
    data['sub_item_details'] = this.subItemId;
...
class ManualStoneDetails {
  ...
  ManualStoneDetails.fromJson(Map<String, dynamic> json) {
    stone = json['stone'];
    reduceWeight = json['reduce_weight'];
...
class ManualDiamondDetails {
  ...
  ManualDiamondDetails.fromJson(Map<String, dynamic> json) {
...
class ManualExchangeDetails {
  ...
  ManualExchangeDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class ManualInvoiceAdvanceDetails {
  int? advanceDetails;
  ...
  ManualInvoiceAdvanceDetails.fromJson(Map<String, dynamic> json) {
...
class ManualTagDetailsRetrieveData {
  int? id;
  String? tagNumber;
  ...
  ManualTagDetailsRetrieveData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class ManualTagDetailStoneDetails {
  String? id;
  bool? reduceWeight;
  int? stonePieces;
  double? stoneWeight;
  ...
  ManualTagDetailStoneDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
    reduceWeight = json['reduce_weight'];
    stonePieces = json['stone_pieces'];
    stoneWeight = json['stone_weight'];
...
class ManualTagDetailDiamondDetails {
  String? id;
  bool? reduceWeight;
  int? diamondPieces;
  double? diamondWeight;
  ...
  ManualTagDetailDiamondDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
    reduceWeight = json['reduce_weight'];
    diamondPieces = json['diamond_pieces'];
    diamondWeight = json['diamond_weight'];
...
class ManualOldPurchaseParticularsDetails {
  String? id;
  String? oldGoldBillNo;
  String? totalAmount;

  ManualOldPurchaseParticularsDetails(
      {this.id, this.oldGoldBillNo, this.totalAmount});

  ManualOldPurchaseParticularsDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class ManualInvoiceSuspenseFetchParticularsDetails {
  String? id;
  String? suspenseId;
  String? totalAmount;

  ManualInvoiceSuspenseFetchParticularsDetails(
      {this.id, this.suspenseId, this.totalAmount});

  ManualInvoiceSuspenseFetchParticularsDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class ManualPaymentDenominationDetails {
  String? sNo;
  ...
  ManualPaymentDenominationDetails(
      {this.paymentMethod,
      this.sNo,
  ...
  ManualPaymentDenominationDetails.fromJson(Map<String, dynamic> json) {
    sNo = json['s_no'];
...
class ManualCreateSuspensePayload {
  int? menuId;
  String? customerDetails;
  String? branch;
  String? remarks;
  List<ManualInvoiceSuspenseItemDetails>? itemDetails;

  ManualCreateSuspensePayload(
      {this.menuId, this.customerDetails, this.branch, this.itemDetails, this.remarks});

  ManualCreateSuspensePayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
    customerDetails = json['customer_details'];
    branch = json['branch'];
    remarks = json['remarks'];
    if (json['item_details'] != null) {
      itemDetails = <ManualInvoiceSuspenseItemDetails>[];
      json['item_details'].forEach((v) {
        itemDetails!.add(new ManualInvoiceSuspenseItemDetails.fromJson(v));
      });
    }
  }
...
class ManualInvoiceSuspenseItemDetails {
  String? sNo;
  int? metalDetails;
  String? metalName;
  String? itemDetails;
  ...
  ManualInvoiceSuspenseItemDetails(
      {this.sNo,
      this.metalDetails,
      this.metalName,
      this.itemDetails,
  ...
  ManualInvoiceSuspenseItemDetails.fromJson(Map<String, dynamic> json) {
    sNo = json['s_no'];
    metalDetails = json['metal_details'];
...
class ManualInvoiceCreateSuspenseResponse {
  int? id;
  String? suspenseId;
  bool? isRedeemed;
  String? billNumber;
  ...
  ManualInvoiceCreateSuspenseResponse(
      {this.id,
      this.suspenseId,
      this.isRedeemed,
      this.billNumber,
  ...
  ManualInvoiceCreateSuspenseResponse.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    suspenseId = json['suspense_id'];
...
class ManualInvoiceSuspenseRetrieveDetails {
  int? id;
  String? suspenseId;
  bool? isRedeemed;
  String? billNumber;
  ...
  ManualInvoiceSuspenseRetrieveDetails(
      {this.id,
      this.suspenseId,
      this.isRedeemed,
      this.billNumber,
  ...
  ManualInvoiceSuspenseRetrieveDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    suspenseId = json['suspense_id'];
    isRedeemed = json['is_redeemed'];
    billNumber = json['bill_number'];
...
class ManualInvoiceOldPurchasePayload {
  int? menuId;
  int? customerDetails;
  String? branch;
  List<ManualInvoiceOldItemDetails>? oldItemDetails;

  ManualInvoiceOldPurchasePayload(
      {this.menuId, this.customerDetails, this.branch, this.oldItemDetails});

  ManualInvoiceOldPurchasePayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
    customerDetails = json['customer_details'];
    branch = json['branch'];
    if (json['old_item_details'] != null) {
      oldItemDetails = <ManualInvoiceOldItemDetails>[];
      json['old_item_details'].forEach((v) {
        oldItemDetails!.add(new ManualInvoiceOldItemDetails.fromJson(v));
      });
    }
  }
...
class ManualInvoiceOldItemDetails {
  String? id;
  String? oldMetal;
  String? oldMetalName;
  String? oldItemName;
  ...
  ManualInvoiceOldItemDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    oldMetal = json['old_metal'];
    oldMetalName = json['old_metal_name'];
...
class ManualInvoiceOldPurchaseCreateResponse {
  int? id;
  ...
  ManualInvoiceOldPurchaseCreateResponse(
      {this.id,
  ...
  ManualInvoiceOldPurchaseCreateResponse.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class ManualOrderTagDetailsListData {
  ...
  String? gstType;
  List<ManualTagDetailsRetrieveData>? itemDetails;

  ManualOrderTagDetailsListData(
      {this.customerMobile,this.orderId, this.metalId, this.metalName, this.customerName,this.orderTotalAmount, this.gstType, this.itemDetails});

  ManualOrderTagDetailsListData.fromJson(Map<String, dynamic> json) {
    ...
    gstType = json['gst_type'];
    if (json['item_details'] != null) {
      itemDetails = <ManualTagDetailsRetrieveData>[];
      json['item_details'].forEach((v) {
        itemDetails!.add(new ManualTagDetailsRetrieveData.fromJson(v));
      });
    }
  }
