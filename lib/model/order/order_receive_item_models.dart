class OrderReceiveItemPayload {
  String? vendor;
  int? menuId;
  int? id;

  OrderReceiveItemPayload({this.vendor, this.menuId, this.id});

  OrderReceiveItemPayload.fromJson(Map<String, dynamic> json) {
    vendor = json['vendor'];
    menuId = json['menu_id'];
    id = json['id'];
  }
...
class OrderReceiveItemResponse {
  int? id;
  double? grossWeight;
  double? netWeight;
  int? pieces;
  ...
  OrderReceiveItemResponse.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class ReceiveOrderItemPaylaod {
  int? menuId;
  List<OrderItemDetails>? orderItemDetails;

  ReceiveOrderItemPaylaod({this.menuId, this.orderItemDetails});

  ReceiveOrderItemPaylaod.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class ReceiveOrderItemResponse {
  int? id;
  double? grossWeight;
  double? netWeight;
  int? pieces;
  ...
  ReceiveOrderItemResponse.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    grossWeight = json['gross_weight'];
    netWeight = json['net_weight'];
    pieces = json['pieces'];
