class FetchOrderItemWiseReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? item;
  ...
  FetchOrderItemWiseReportListPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class OrderItemWiseReportListData {
  int? id;
  String? itemName;
  String? itemCode;
  double? huidCharges;
  ...
  OrderItemWiseReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
