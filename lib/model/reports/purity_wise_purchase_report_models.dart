class FetchPurityWisePurchaseReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? purity;
  ...
  FetchPurityWisePurchaseReportListPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class PurityWisePurchaseReportListData {
  int? id;
  String? purityName;
  String? purityCode;
  ...
  PurityWisePurchaseReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
