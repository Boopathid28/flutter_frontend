class FetchPurchasewiseMetalRepaortListDataPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? metal;
  ...
  FetchPurchasewiseMetalRepaortListDataPayload.fromJson(
...
class PurchasewiseMetalRepaortListData {
  int? id;
  String? metalName;
  String? metalCode;
  bool? isActive;
  ...
  PurchasewiseMetalRepaortListData(
      {this.id,
      this.metalName,
      this.metalCode,
      this.isActive,
  ...
  PurchasewiseMetalRepaortListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
