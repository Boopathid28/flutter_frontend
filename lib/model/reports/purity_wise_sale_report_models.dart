class PurityWiseSaleReport {
  ...
  PurityWiseSaleReport.fromJson(Map<String, dynamic> json) {
...
class PurityWiseSaleReportPayload {
  String? menuId;
  String? branch;
  dynamic fromDate;
  dynamic toDate;
  ...
  PurityWiseSaleReportPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
    branch = json['branch'];
