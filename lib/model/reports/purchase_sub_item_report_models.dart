class FetchPurchaseSubitemreportlistdataPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? item;
  ...
  FetchPurchaseSubitemreportlistdataPayload.fromJson(
...
class PurchaseSubitemreportlistdata {
  int? id;
  String? subItemName;
  String? subItemCode;
  String? hsnCode;
  ...
  PurchaseSubitemreportlistdata.fromJson(Map<String, dynamic> json) {
    id = json['id'];
