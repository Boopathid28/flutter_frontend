class FetchPurchaseitemreportlistdataPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? item;
  ...
  FetchPurchaseitemreportlistdataPayload(
      {this.menuId,
      this.fromDate,
      this.toDate,
      this.item,
  ...
  FetchPurchaseitemreportlistdataPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class Purchaseitemreportlistdata {
  int? id;
  String? itemName;
  String? itemCode;
  double? huidCharges;
  ...
  Purchaseitemreportlistdata.fromJson(Map<String, dynamic> json) {
    id = json['id'];
