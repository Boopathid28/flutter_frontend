class FetchVendorWiseRepairReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? designer;
  ...
  FetchVendorWiseRepairReportListPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class VendorWiseRepairReportListData {
  int? id;
  String? designerName;
  String? designerCode;
  String? email;
  ...
  VendorWiseRepairReportListData(
      {this.id,
      this.designerName,
      this.designerCode,
      this.email,
  ...
  VendorWiseRepairReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
