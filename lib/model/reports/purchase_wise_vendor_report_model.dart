class FetchPurchasewiseVendorReportListDataPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? designer;
  ...
  FetchPurchasewiseVendorReportListDataPayload.fromJson(
...
class PurchasewiseVendorReportListData {                                                                                
  int? id;
  String? designerName;
  String? designerCode;
  String? email;
  ...
  PurchasewiseVendorReportListData(
      {this.id,
      this.designerName,
      this.designerCode, 
      this.email,
  ...
  PurchasewiseVendorReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
