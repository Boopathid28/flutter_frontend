class FetchOrderMetalWiseReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? metal;
  ...
  FetchOrderMetalWiseReportListPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class OrderMetalWiseReportListData {
  int? id;
  String? metalName;
  String? metalCode;
  bool? isActive;
  ...
  OrderMetalWiseReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
