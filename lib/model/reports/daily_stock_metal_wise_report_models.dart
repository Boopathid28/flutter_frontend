class DailyStockMetalWiseReport {
  List<DailyStockMetalWiseReportList>? list;
  num? totalOutPieces;
  num? totalInPieces;
  num? totalOutWeight;
  num? totalInWeight;
  ...
  DailyStockMetalWiseReport.fromJson(Map<String, dynamic> json) {
    if (json['list'] != null) {
      list = <DailyStockMetalWiseReportList>[];
      json['list'].forEach((v) {
        list!.add(new DailyStockMetalWiseReportList.fromJson(v));
      });
    }
...
class DailyStockMetalWiseReportList {
  num? id;
  String? metalName;
  String? metalCode;
  bool? isActive;
  ...
  DailyStockMetalWiseReportList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class DailyStockMetalWiseReportPayload {
  String? menuId;
  dynamic fromDate;
  String? metal;
  num? page;
  ...
  DailyStockMetalWiseReportPayload(
      {this.menuId,
      this.fromDate,
      this.metal,
      this.page,
  ...
  DailyStockMetalWiseReportPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
