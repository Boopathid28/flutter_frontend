class SubitemWiseSaleReport {
  ...
  SubitemWiseSaleReport.fromJson(Map<String, dynamic> json) {
...
class SubitemWiseSaleReportPayload {
  String? menuId;
  String? branch;
  dynamic fromDate;
  dynamic toDate;
  ...
  SubitemWiseSaleReportPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
    branch = json['branch'];
    ...
    excelDownload = json['excel_download'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['excel_download'] = excelDownload;
    return data;
  }
}
