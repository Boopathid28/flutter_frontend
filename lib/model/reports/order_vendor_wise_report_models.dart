class FetchOrderVendorWiseReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? designer;
  ...
  FetchOrderVendorWiseReportListPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class OrderVendorWiseReportListData {
  int? id;
  String? designerName;
  String? designerCode;
  String? email;
  ...
  OrderVendorWiseReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
