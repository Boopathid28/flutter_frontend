class FetchOrderSubItemWiseReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? item;
  ...
  FetchOrderSubItemWiseReportListPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class OrderSubItemWiseReportListData {
  int? id;
  String? subItemName;
  String? subItemCode;
  String? hsnCode;
  ...
  OrderSubItemWiseReportListData(
      {this.id,
      this.subItemName,
      this.subItemCode,
      this.hsnCode,
  ...
  OrderSubItemWiseReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
