class FetchEstimationSubItemWiseReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? item;
  ...
  FetchEstimationSubItemWiseReportListPayload.fromJson(
...
class EstimationSubItemWiseReportListData {
  int? id;
  String? subItemName;
  String? subItemCode;
  String? hsnCode;
  ...
  EstimationSubItemWiseReportListData(
      {this.id,
      this.subItemName,
      this.subItemCode,
      this.hsnCode,
  ...
  EstimationSubItemWiseReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
