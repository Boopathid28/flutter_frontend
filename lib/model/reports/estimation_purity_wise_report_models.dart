class FetchEstimationPurityWiseReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? purity;
  ...
  FetchEstimationPurityWiseReportListPayload.fromJson(
...
class EstimationPurityWiseReportListData {
  int? id;
  String? purityName;
  String? purityCode;
  ...
  EstimationPurityWiseReportListData(
      {this.id,
      this.purityName,
      this.purityCode,
      this.purityPercent,
  ...
  EstimationPurityWiseReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
