class FetchMetalWiseRepairListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? metal;
  ...
  FetchMetalWiseRepairListPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class MetalWiseRepairListData {
  ...
  MetalWiseRepairListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
