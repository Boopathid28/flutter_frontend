class FetchOrderPurityWiseReportListPayload {
  int? menuId;
  String? fromDate;
  String? toDate;
  String? purity;
  ...
  FetchOrderPurityWiseReportListPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
...
class OrderPurityWiseReportListData {
  int? id;
  String? purityName;
  String? purityCode;
  ...
  OrderPurityWiseReportListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
