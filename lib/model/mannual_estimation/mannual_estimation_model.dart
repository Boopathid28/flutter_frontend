...
class MannualEstimationPayload {
  int? menuId;
  ...
  String? branch;
  List<MannualParticularDetails>? particularDetails;
  List<MannualExchangeDetails>? exchangeDetails;
  List<int>? oldPurchaseDetails;
  List<MannualEstimationAdvanceDetails>? advanceDetails;
  List<ChitPaymentDetails>? chitDetails;

  MannualEstimationPayload(
      {this.menuId,
      this.estimationDate,
  ...
  MannualEstimationPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
    ...
    if (json['particular_details'] != null) {
      particularDetails = <MannualParticularDetails>[];
      json['particular_details'].forEach((v) {
        particularDetails!.add(new MannualParticularDetails.fromJson(v));
      });
    }
    if (json['exchange_details'] != null) {
      exchangeDetails = <MannualExchangeDetails>[];
      json['exchange_details'].forEach((v) {
        exchangeDetails!.add(new MannualExchangeDetails.fromJson(v));
      });
    }
    oldPurchaseDetails = json['old_purchase_details'].cast<int>();
    if (json['advance_details'] != null) {
      advanceDetails = <MannualEstimationAdvanceDetails>[];
      json['advance_details'].forEach((v) {
        advanceDetails!.add(new MannualEstimationAdvanceDetails.fromJson(v));
      });
    }
...
class MannualParticularDetails {
  String? sNo;
  String? tag;
  double? rate;
  double? minRate;
  ...
  List<MannualTagDetailStoneDetails>? stoneDetails;
  List<MannualTagDetailDiamondDetails>? diamondDetails;
  String? purity;
  String? purityName;

  MannualParticularDetails(
      {this.sNo,
      this.tag,
      this.rate,
      this.minRate,
  ...
  MannualParticularDetails.fromJson(Map<String, dynamic> json) {
    sNo = json['s_no'];
    tag = json['tag'];
    rate = json['rate'];
    ...
    if (json['stone_details'] != null) {
      stoneDetails = <MannualTagDetailStoneDetails>[];
      json['stone_details'].forEach((v) {
        stoneDetails!.add(new MannualTagDetailStoneDetails.fromJson(v));
      });
    } else {
      json['stone_details'] = null;
    }
    if (json['diamond_details'] != null) {
      diamondDetails = <MannualTagDetailDiamondDetails>[];
      json['diamond_details'].forEach((v) {
        diamondDetails!.add(new MannualTagDetailDiamondDetails.fromJson(v));
      });
    }
    purity = json['purity'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['subitem_id'] = this.subitemId;
    data['item_name'] = this.itemName;
    data['subitem_name'] = this.subitemName;
...
class MannualStoneDetails {
  ...
  MannualStoneDetails.fromJson(Map<String, dynamic> json) {
    stone = json['stone'];
    reduceWeight = json['reduce_weight'];
...
class MannualDiamondDetails {
  ...
  MannualDiamondDetails.fromJson(Map<String, dynamic> json) {
...
class MannualExchangeDetails {
  ...
  MannualExchangeDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class MannualEstimationAdvanceDetails {
  int? advanceDetails;
  ...
  MannualEstimationAdvanceDetails(
      {this.advanceDetails,
  ...
  MannualEstimationAdvanceDetails.fromJson(Map<String, dynamic> json) {
...
class MannualTagDetailsRetrieveData {
  int? id;
  String? tagNumber;
  ...
  MannualTagDetailsRetrieveData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    stoneReduceWeight =
        double.parse(json['stone_reduce_weight'].toString() ?? "0");
    diamondReduceWeight =
        double.parse(json['diamond_reduce_weight'].toString() ?? "0");
    if (json['stone_details'] != null) {
      stoneDetails = <MannualTagDetailStoneDetails>[];
      json['stone_details'].forEach((v) {
        stoneDetails!.add(new MannualTagDetailStoneDetails.fromJson(v));
...
class MannualTagDetailStoneDetails {
  String? id;
  bool? reduceWeight;
  int? stonePieces;
  double? stoneWeight;
  ...
  MannualTagDetailStoneDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
    reduceWeight = json['reduce_weight'];
    stonePieces = json['stone_pieces'];
    stoneWeight = json['stone_weight'];
...
class MannualTagDetailDiamondDetails {
  String? id;
  bool? reduceWeight;
  int? diamondPieces;
  double? diamondWeight;
  ...
  MannualTagDetailDiamondDetails(
      {this.id,
      this.reduceWeight,
      this.diamondPieces,
      this.diamondWeight,
  ...
  MannualTagDetailDiamondDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
    reduceWeight = json['reduce_weight'];
    diamondPieces = json['diamond_pieces'];
    diamondWeight = json['diamond_weight'];
...
class MannualOldPurchaseParticularsDetails {
  String? id;
  String? oldGoldBillNo;
  String? totalAmount;

  MannualOldPurchaseParticularsDetails(
      {this.id, this.oldGoldBillNo, this.totalAmount});

  MannualOldPurchaseParticularsDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
