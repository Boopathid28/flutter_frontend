class EstimationHistoryListData {
  int? id;
  String? estimationId;
  ...
  EstimationHistoryListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class FetchEstimationHistoryPayload {
  int? menuId;
  String? branch;
  String? metalType;
  String? customer;
  ...
  FetchEstimationHistoryPayload.fromJson(Map<String, dynamic> json) {
    menuId = json['menu_id'];
    branch = json['branch'];
...
class RetrieveEstimationDetails {
  int? id;
  String? estimationId;
  String? estimationDate;
  double? totalAmount;
  ...
  RetrieveEstimationDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    estimationId = json['estimation_id'];
    estimationDate = json['estimation_date'];
    totalAmount = json['total_amount'];
...
class RetrieveParticularDetails {
  ...
  List<EstimationStoneDetails>? stoneDetails;
  List<EstimationDiamondDetails>? diamondDetails;
  ...
  RetrieveParticularDetails.fromJson(Map<String, dynamic> json) {
    ...
    if (json['stone_details'] != null) {
      stoneDetails = <EstimationStoneDetails>[];
      json['stone_details'].forEach((v) {
        stoneDetails!.add(new EstimationStoneDetails.fromJson(v));
      });
    }
    if (json['diamond_details'] != null) {
      diamondDetails = <EstimationDiamondDetails>[];
      json['diamond_details'].forEach((v) {
        diamondDetails!.add(new EstimationDiamondDetails.fromJson(v));
      });
    }
  }
...
class EstimationStoneDetails {
  ...
  EstimationStoneDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    reduceWeight = json['reduce_weight'];
...
class EstimationDiamondDetails {
  int? id;
  bool? reduceWeight;
  int? diamondPieces;
  ...
  EstimationDiamondDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    reduceWeight = json['reduce_weight'];
