...
class BillingTextInput extends StatelessWidget {
  ...
  double height;
  Color filledColor;
  bool isBillingValidator;
  String? Function(String?)? billingValidator;
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: TextFormField(
        ...
        onChanged: onChanged,
        validator: isBillingValidator ? billingValidator : (value) {
          var result = "";
        ...
        decoration: InputDecoration(
            ...
            hintText: hintText,
            hintStyle: TextStyle(color: ColorPalete.filledInputPlaceholderColor, fontSize: 10),
            ...
            contentPadding: Responsive.isDesktop(context) || Responsive.isTablet(context) ?
                EdgeInsets.symmetric(vertical: 5.h, horizontal: 5.w) : EdgeInsets.symmetric(vertical: 5.h, horizontal: 5.w)),
      ),
    );
  }
