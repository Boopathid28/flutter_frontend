...
import 'package:ausales_application/view/widgets/screen_widgets/itemtag/itemtag_form/stone_details_form.dart';
                            ...
                            return DataRow(cells: [
                              ...
                              DataCell(Row(
                                children: [
                                  GestureDetector(
                                      onTap: () {
                                        _itemtagStoneFormController.editItemtagStone(context, item);
                                  ...
                                  GestureDetector(
                                      onTap: () async {
                                        await showDialog(
                                          context: context, 
                                          builder: (_) => DeleteStonePopup(itemIndex: item.sNo)
                                        );
        ...
        children: [
          ...
          SizedBox(
              ...
              child: PrimaryButton(
                  ...
                  text: "Done",
                  onPressed: () {
                    _itemtagFormController.stoneAddCompleted(context);
                    Get.back();
                  })),
        ],
      ),
