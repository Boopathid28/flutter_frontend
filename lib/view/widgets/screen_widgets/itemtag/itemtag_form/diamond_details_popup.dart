...
import 'package:ausales_application/view/widgets/screen_widgets/itemtag/itemtag_form/diamond_details_form.dart';
                            ...
                            return DataRow(cells: [
                              ...
                              DataCell(Row(
                                children: [
                                  GestureDetector(
                                      onTap: () {
                                        _itemtagDiamondFormController.editItemtagDiamond(context, item);
                                  ...
                                  GestureDetector(
                                      onTap: () async {
                                        await showDialog(
                                          context: context, 
                                          builder: (_) => DeleteDiamondPopup(itemIndex: item.sNo)
                                        );
        ...
        children: [
          ...
          SizedBox(
              ...
              child: PrimaryButton(
                  ...
                  text: "Done",
                  onPressed: () {
                    _itemtagFormController.diamondAddCompleted(context);
                    Get.back();
                  })),
        ],
      ),
