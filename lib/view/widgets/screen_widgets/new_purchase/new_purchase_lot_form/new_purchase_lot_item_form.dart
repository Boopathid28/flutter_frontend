...
class NewPurchaseLotItemForm extends StatefulWidget {
  const NewPurchaseLotItemForm({super.key});

  @override
  State<NewPurchaseLotItemForm> createState() => _NewPurchaseLotItemFormState();
}

class _NewPurchaseLotItemFormState extends State<NewPurchaseLotItemForm> {
