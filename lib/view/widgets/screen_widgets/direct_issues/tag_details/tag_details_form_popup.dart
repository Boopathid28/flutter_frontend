...
import 'package:ausales_application/view/widgets/screen_widgets/approval_issues/tag_details/delete_tag_popup.dart';
import 'package:ausales_application/view/widgets/screen_widgets/approval_issues/tag_details/tag_details_popup.dart';
import 'package:ausales_application/view/widgets/screen_widgets/direct_issues/tag_details/tag_details_popup.dart';
...
class TagDetailsFormPopup extends StatefulWidget {
  const TagDetailsFormPopup({super.key});

  @override
  State<TagDetailsFormPopup> createState() => _TagDetailsFormPopupState();
}

class _TagDetailsFormPopupState extends State<TagDetailsFormPopup> {
      ...
      title: Row(
        ...
        children: [
          ...
          IconButton(
              onPressed: () {
                Get.back();
                _directIssuesTagFormController.resetForm();
              },
                ...
                child: SingleChildScrollView(
                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => DataTable(
                          ...
                          rows: _directIssuesFormController
                              .itemtagParticularList.value
                              .map((item) {
                            return DataRow(cells: [
                              DataCell(Text(item.tagNumber.toString())),
                              DataCell(
                                  Text(item.MetalDetailsName.toString())),
                                  DataCell(
                                  Text(item.itemDetailsName.toString())),
                              DataCell(
                                ...
                                children: [
                                  GestureDetector(
                                      onTap: () async {
                                        await showDialog(
                                            context: context,
                                            builder: (_) => DeleteApprovalTagpopup(
                                                itemIndex:
                                                    item.sNo.toString()));
                                      },
    ...
    return SizedBox(
      ...
      child: SizedBox(
          ...
          child: PrimaryButton(
            ...
            text: "Done",
            onPressed: () async {
              _directIssuesFormController.gettagId(context);
            },
          )),
    );
  }
