...
class CustomerCrDrReportData extends StatefulWidget {
  const CustomerCrDrReportData({super.key});

  @override
  State<CustomerCrDrReportData> createState() =>
      _CustomerCrDrReportDataState();
}

class _CustomerCrDrReportDataState
    extends State<CustomerCrDrReportData> {
  final CustomerCrDrReportListController
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      "${_customerCrDrReportListController.TotalCr ?? ""}",
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      "${_customerCrDrReportListController.TotalDr ?? ""}",
                      style: TextPalette.viewDetailsDataTextStyle,
                    ),
                  ],
                ),
