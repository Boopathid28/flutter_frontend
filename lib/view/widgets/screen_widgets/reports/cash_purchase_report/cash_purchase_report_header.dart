...
class CashPurchaseReportHeader extends StatefulWidget {
  const CashPurchaseReportHeader({super.key});

  @override
  State<CashPurchaseReportHeader> createState() =>
      _CashPurchaseReportHeaderState();
}

class _CashPurchaseReportHeaderState
    extends State<CashPurchaseReportHeader> {
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextInput(
              readOnly: true,
              controller:
                  _cashPurchaseReportListController.datarangefilterController,
              ...
              suffixClicked: () {
                _cashPurchaseReportListController.datarangefilterController.clear();
              ...
              onTap: () async {
                ...
                if (pickedDate != null) {
                  ...
                  var endDate = pickedDate.end
                      ...
                      .toString()
                      .substring(0, 10);
                  _cashPurchaseReportListController.datarangefilterController.text =
