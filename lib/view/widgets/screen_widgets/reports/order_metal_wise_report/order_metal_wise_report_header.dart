...
class OrderMetalWiseReportHeader extends StatefulWidget {
  const OrderMetalWiseReportHeader({super.key});

  @override
  State<OrderMetalWiseReportHeader> createState() =>
      _OrderMetalWiseReportHeaderState();
}

class _OrderMetalWiseReportHeaderState
    extends State<OrderMetalWiseReportHeader> {
    ...
    return SizedBox(
        ...
        child: Obx(() => Column(
              ...
              children: [
                ...
                CustomDropdownSearchField(
                  controller:
                      _orderMetalWiseReportListController.searchMetalController,
                  filled: true,
                  selectedValue:
                      _orderMetalWiseReportListController.selectedmetal.value,
                  options:
                      _orderMetalWiseReportListController.metalFilterList.value,
                  onChanged: (value) {
                    _orderMetalWiseReportListController.selectedmetal(value);
                    _orderMetalWiseReportListController
                        .getordermetalwisereport(context);
