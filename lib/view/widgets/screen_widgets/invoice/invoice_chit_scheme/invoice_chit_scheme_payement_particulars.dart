...
class InvoiceChitSchemePayementParticulars extends StatefulWidget {
  List<ChitPaymentDenominationParticulars> chitItemsList;
  List<ChitSchemeListData> selectedChitSchemeList;

  InvoiceChitSchemePayementParticulars({super.key, required this.chitItemsList, required this.selectedChitSchemeList});

  @override
  State<InvoiceChitSchemePayementParticulars> createState() => _InvoiceChitSchemePayementParticularsState();
}

class _InvoiceChitSchemePayementParticularsState extends State<InvoiceChitSchemePayementParticulars> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Obx(() => _chitSchemeController.isCitSchemeFetchLoading.value
              ? Padding(
              ...
              : ListView(
                  children: [
                    Obx(() => PaginatedDataTable(
                          ...
                          source: _DataSource(
                              context, _chitSchemeController.chitSchemeAllList.value, widget.chitItemsList, widget.selectedChitSchemeList),
                        )),
                  ],
                )),
        ],
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: [
        DataCell(
          Obx(() => Checkbox(
            value: _chitSchemeController.selectedChitSchemeIdsList.value.contains(row.id) ? true : false,
            onChanged: (value) {
              _chitSchemeController.onSelectedValueChanged(row);
            },
          ))
        ),
        DataCell(Text(
