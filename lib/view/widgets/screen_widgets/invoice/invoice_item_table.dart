...
class InvoiceItemTable extends StatefulWidget {
  const InvoiceItemTable({super.key});
        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Obx(() => DataTable(
              ...
              rows: _invoiceController.particulars.value.map((item) {
                return DataRow(cells: [
                  DataCell(Row(
                    children: [
                      GestureDetector(onTap: () {
                        _invoiceItemController.editParticularItem(context, item);
                      ...
                      GestureDetector(onTap: () {
                        _invoiceItemController.deleteParticularItem(context, item);
