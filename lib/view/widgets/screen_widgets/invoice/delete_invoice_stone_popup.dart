...
class DeleteInvoiceStonePopup extends StatefulWidget {
  String itemIndex;
  DeleteInvoiceStonePopup({super.key, required this.itemIndex});

  @override
  State<DeleteInvoiceStonePopup> createState() => _DeleteInvoiceStonePopupState();
}

class _DeleteInvoiceStonePopupState extends State<DeleteInvoiceStonePopup> {
