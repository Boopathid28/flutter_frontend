...
class ManualDeleteInvoiceStonePopup extends StatefulWidget {
  String itemIndex;
  ManualDeleteInvoiceStonePopup({super.key, required this.itemIndex});

  @override
  State<ManualDeleteInvoiceStonePopup> createState() => _ManualDeleteInvoiceStonePopupState();
}

class _ManualDeleteInvoiceStonePopupState extends State<ManualDeleteInvoiceStonePopup> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PrimaryButton(
                ...
                text: "Yes", 
                onPressed: () async {
                  _manualInvoiceStoneFormController
                  .deleteManualItemtagStone(context, widget.itemIndex);
                }
              ),
            )
          ],
