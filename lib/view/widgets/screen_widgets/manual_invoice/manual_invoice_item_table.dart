...
class ManualInvoiceItemTable extends StatefulWidget {
  const ManualInvoiceItemTable({super.key});

  @override
  State<ManualInvoiceItemTable> createState() => _ManualInvoiceItemTableState();
}

class _ManualInvoiceItemTableState extends State<ManualInvoiceItemTable> {
        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Obx(() => DataTable(
              ...
              rows: _manualInvoiceController.particulars.value.map((item) {
                return DataRow(cells: [
                  DataCell(Row(
                    children: [
                      GestureDetector(onTap: () {
                        _manualInvoiceItemController.editManualParticularItem(context, item);
                      ...
                      GestureDetector(onTap: () {
                        _manualInvoiceItemController.deleteManualParticularItem(context, item);
