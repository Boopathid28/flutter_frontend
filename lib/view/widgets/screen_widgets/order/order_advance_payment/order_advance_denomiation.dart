import 'package:ausales_application/controller/order/order_advance/advance_denomiation_form.dart';
...
class OrderAdvanceDenomiation extends StatefulWidget {
  const OrderAdvanceDenomiation({super.key});

  @override
  State<OrderAdvanceDenomiation> createState() => _OrderAdvanceDenomiationState();
}

class _OrderAdvanceDenomiationState extends State<OrderAdvanceDenomiation> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => DataTable(
                          ...
                          rows:
                              _orderAdvancePaymentController.paymentParticulars.value.map((item) {
