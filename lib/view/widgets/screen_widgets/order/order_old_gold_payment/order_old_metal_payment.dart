...
import 'package:ausales_application/view/widgets/screen_widgets/order/order_old_gold_payment/order_old_metal_payment_item_form.dart';
import 'package:ausales_application/view/widgets/screen_widgets/order/order_old_gold_payment/order_old_metal_payment_particulars_table.dart';
import 'package:ausales_application/view/widgets/screen_widgets/order/order_old_gold_payment/order_selected_old_metal_list.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class OrderOldMetalPayment extends StatefulWidget {
  RxList<OrderOldPurchasePaymentParticularsDetails> oldMetalFetchParticulars;
  RxList<OldItemPaymentDetails> oldMetalParticulars;
  Function() onCompleted;
  OrderOldMetalPayment({
    super.key,
  ...
  @override
  State<OrderOldMetalPayment> createState() => _OrderOldMetalPaymentState();
}

class _OrderOldMetalPaymentState extends State<OrderOldMetalPayment> {
          ...
          Column(
            ...
            children: [
              ...
              BillingTextInput(
                ...
                controller:
                    _orderOldMetalPaymentController.oldMetalSearchController,
          ...
          Row(
            ...
            children: [
              Obx(() => PrimaryButton(
                  ...
                  isLoading: _orderOldMetalPaymentController
                      .isOldMetalFetchLoading.value,
                  text: 'Fetch Details',
                  onPressed: () {
                    _orderOldMetalPaymentController.getOldMetalDetails(context,
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  OrderOldMetalPaymentItemForm(
                                      itemsList: widget.oldMetalParticulars),
                                  SizedBox(
                                    height: 15.h,
                                  ),
                                  OrderOldMetalPaymentParticularsTable(
