...
import 'package:ausales_application/view/widgets/screen_widgets/itemtag/itemtag_form/delete_diamond_popup.dart';
import 'package:ausales_application/view/widgets/screen_widgets/order/diamond_details/diamond_details_form.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class DiamondDetailsPopup extends StatefulWidget {
  const DiamondDetailsPopup({super.key});

  @override
  State<DiamondDetailsPopup> createState() => _DiamondDetailsPopupState();
}

class _DiamondDetailsPopupState extends State<DiamondDetailsPopup> {
                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => DataTable(
                          ...
                          rows: _orderItemFormController
                              .diamonddetailsParticulars.value
                              .map((item) {
                            return DataRow(cells: [
                              ...
                              DataCell(Row(
                                children: [
                                  GestureDetector(
                                      onTap: () {
                                        _orderDiamondFormController.editOrderDiamond(context, item);
                                  ...
                                  GestureDetector(
                                      onTap: () async {
                                        await showDialog(
                                          context: context, 
                                          builder: (_) => DeleteDiamondPopup(itemIndex: item.sNo.toString())
                                        );
                                      },
        ...
        children: [
          ...
          SizedBox(
              ...
              child: PrimaryButton(
                  ...
                  text: "Done",
                  onPressed: () {
                    _orderDiamondFormController.diamondAddCompleted(context);
                  })),
        ],
      ),
    );
