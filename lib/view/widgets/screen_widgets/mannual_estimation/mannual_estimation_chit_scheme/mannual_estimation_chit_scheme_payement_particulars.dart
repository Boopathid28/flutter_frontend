...
class MannualEstimationChitSchemePayementParticulars extends StatefulWidget {
  List<ChitPaymentDenominationParticulars> chitItemsList;
  List<ChitSchemeListData> selectedChitSchemeList;

  MannualEstimationChitSchemePayementParticulars({super.key, required this.chitItemsList, required this.selectedChitSchemeList});

  @override
  State<MannualEstimationChitSchemePayementParticulars> createState() => _MannualEstimationChitSchemePayementParticularsState();
}

class _MannualEstimationChitSchemePayementParticularsState extends State<MannualEstimationChitSchemePayementParticulars> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Obx(() => _mannualEstimationChitSchemeController.isCitSchemeFetchLoading.value
              ? Padding(
              ...
              : ListView(
                  children: [
                    Obx(() => PaginatedDataTable(
                          ...
                          source: _DataSource(
                              context, _mannualEstimationChitSchemeController.chitSchemeAllList.value, widget.chitItemsList, widget.selectedChitSchemeList),
                        )),
                  ],
                )),
        ],
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: [
        DataCell(
          Obx(() => Checkbox(
            value: _mannualEstimationChitSchemeController.selectedChitSchemeIdsList.value.contains(row.id) ? true : false,
            onChanged: (value) {
              _mannualEstimationChitSchemeController.onSelectedValueChanged(row);
            },
          ))
        ),
        DataCell(Text(
