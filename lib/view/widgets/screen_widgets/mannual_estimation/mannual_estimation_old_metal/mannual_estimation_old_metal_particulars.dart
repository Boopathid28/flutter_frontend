...
class MannualEstimationOldMetalParticulars extends StatefulWidget {
  const MannualEstimationOldMetalParticulars({super.key});

  @override
  State<MannualEstimationOldMetalParticulars> createState() => _MannualEstimationOldMetalParticularsState();
}

class _MannualEstimationOldMetalParticularsState extends State<MannualEstimationOldMetalParticulars> {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Obx(() => DataTable(
              ...
              rows: _mannualEstimationController.oldParticulars.value.map((item) {
                return DataRow(cells: [
                  DataCell(Row(
                    children: [
                      GestureDetector(onTap: () {
                        _mannualEstimationOldItemFormController.editItem(item);
                      }, child: Icon(Icons.edit)),
                      SizedBox(
                        width: 10.w,
                      ),
                      GestureDetector(onTap: () {
                        _mannualEstimationOldItemFormController.deleteItem(item);
