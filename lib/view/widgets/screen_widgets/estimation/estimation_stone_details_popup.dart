...
class EstimationStoneDetailsPopup extends StatefulWidget {
  const EstimationStoneDetailsPopup({super.key});

  @override
  State<EstimationStoneDetailsPopup> createState() => _EstimationStoneDetailsPopupState();
}

class _EstimationStoneDetailsPopupState extends State<EstimationStoneDetailsPopup> {
                                ...
                                children: [
                                  GestureDetector(
                                      onTap: () {
                                        ...
                                        _estimationStoneFormController.editItemtagStone(context, item);
                                  ...
                                  GestureDetector(
                                      onTap: () async {
                                        await showDialog(
                                          context: context, 
                                          builder: (_) => DeleteEstimationStonePopup(itemIndex: item.id.toString())
                                        );
        ...
        children: [
          ...
          SizedBox(
              ...
              child: PrimaryButton(
                  ...
                  text: "Done",
                  onPressed: () {
                    _estimationStoneFormController.stoneAddCompleted(context);
                  })),
        ],
      ),
    );
