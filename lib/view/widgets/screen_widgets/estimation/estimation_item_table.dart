...
class EstimationItemTable extends StatefulWidget {
  const EstimationItemTable({super.key});

  @override
  State<EstimationItemTable> createState() => _EstimationItemTableState();
}

class _EstimationItemTableState extends State<EstimationItemTable> {
        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Obx(() => DataTable(
              ...
              rows: _estimationController.particulars.value.map((item) {
                return DataRow(cells: [
                  DataCell(Row(
                    children: [
                      GestureDetector(onTap: () {
                        _estimationItemController.editParticularItem(context, item);
                      ...
                      GestureDetector(onTap: () {
                        _estimationItemController.deleteParticularItem(context, item);
