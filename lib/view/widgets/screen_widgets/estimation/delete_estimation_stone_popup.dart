...
class DeleteEstimationStonePopup extends StatefulWidget {
  String itemIndex;
  DeleteEstimationStonePopup({super.key, required this.itemIndex});

  @override
  State<DeleteEstimationStonePopup> createState() => _DeleteEstimationStonePopupState();
}

class _DeleteEstimationStonePopupState extends State<DeleteEstimationStonePopup> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PrimaryButton(
                ...
                text: "Yes", 
                onPressed: () async {
                  _estimationStoneFormController
