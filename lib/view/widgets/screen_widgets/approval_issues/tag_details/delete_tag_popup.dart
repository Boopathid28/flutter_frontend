...
class DeleteApprovalTagpopup extends StatefulWidget {
  String itemIndex;
  DeleteApprovalTagpopup({super.key, required this.itemIndex});

  @override
  State<DeleteApprovalTagpopup> createState() => _DeleteApprovalTagpopupState();
}

class _DeleteApprovalTagpopupState extends State<DeleteApprovalTagpopup> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PrimaryButton(
                ...
                text: "Yes", 
                onPressed: () async {
                  _aprovalIssuesTagFormController.deleteItemtag(context, widget.itemIndex);
                }
              ),
            )
          ],
