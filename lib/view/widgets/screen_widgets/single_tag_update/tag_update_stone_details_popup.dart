...
class TagUpdateStoneDetailsPopup extends StatefulWidget {
  const TagUpdateStoneDetailsPopup({super.key});

  @override
  State<TagUpdateStoneDetailsPopup> createState() => _TagUpdateStoneDetailsPopupState();
}

class _TagUpdateStoneDetailsPopupState extends State<TagUpdateStoneDetailsPopup> {
                            ...
                            return DataRow(cells: [
                              ...
                              DataCell(Row(
                                children: [
                                  GestureDetector(
                                      onTap: () {
                                        _singleTagUdpdateStoneFormController.editUpdatetagStone(context, item);
                                  ...
                                  GestureDetector(
                                      onTap: () async {
                                        await showDialog(
                                          context: context, 
                                          builder: (_) => DeleteTagUpdateStonePopup(itemIndex: item.id!, item: item)
                                        );
        ...
        children: [
          ...
          SizedBox(
              ...
              child: PrimaryButton(
                  ...
                  text: "Done",
                  onPressed: () {
                    _singleTagUdpdateStoneFormController.stoneAddCompleted(context);
                  })),
        ],
      ),
    );
