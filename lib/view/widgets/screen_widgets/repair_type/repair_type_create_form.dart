...
class RepairTypeCreateForm extends StatefulWidget {
  const RepairTypeCreateForm({super.key});

  @override
  State<RepairTypeCreateForm> createState() => _RepairTypeCreateFormState();
}

class _RepairTypeCreateFormState extends State<RepairTypeCreateForm> {
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Text('Create Repair Type',style:Responsive.isMobile(context)?TextPalette.tableDataTextStyle: TextPalette.screenTitle,),
