...
class ChitSchemePaymentTagParticulars extends StatefulWidget {
  List<RetrieveParticularDetails> taggedItems;
  Function() onComplete;
  List<RetrieveParticularDetails> selectedTagChitPaymentParticulars;
  ChitSchemePaymentTagParticulars({super.key, required this.taggedItems, required this.onComplete, required this.selectedTagChitPaymentParticulars});

  @override
  State<ChitSchemePaymentTagParticulars> createState() =>
      _ChitSchemePaymentTagParticularsState();
}

class _ChitSchemePaymentTagParticularsState
    extends State<ChitSchemePaymentTagParticulars> {
  @override
...
class _DataSource extends DataTableSource {
  ...
  List<RetrieveParticularDetails> data;
  List<RetrieveParticularDetails> selectedTagChitPaymentParticulars;
    ...
    return DataRow.byIndex(
      ...
      cells: [
        DataCell(Obx(() => Checkbox(
              value: _chitSchemePaymentController.selectedTagItemIdsList.contains(row.id),
              onChanged: (value) {
                _chitSchemePaymentController.selecteTagItems(context, row, index, data, selectedTagChitPaymentParticulars);
              },
            ))),
        DataCell(Text(
