...
class OldMetalPaymentParticularsTable extends StatefulWidget {
  List<OldItemPaymentDetails> particularList;
  OldMetalPaymentParticularsTable({super.key, required this.particularList});

  @override
  State<OldMetalPaymentParticularsTable> createState() =>
      _OldMetalPaymentParticularsTableState();
}

class _OldMetalPaymentParticularsTableState
    extends State<OldMetalPaymentParticularsTable> {
                ...
                DataCell(Row(
                    children: [
                      GestureDetector(onTap: () {
                        _oldMetalPaymentController.editItem(item);
                      }, child: Icon(Icons.edit)),
                      SizedBox(
                        width: 10.w,
                      ),
                      GestureDetector(onTap: () {
                        _oldMetalPaymentController.deleteItem(widget.particularList, item.id!);
