import 'package:ausales_application/controller/payment_controllers/advance_denomiation_form.dart';
...
class AdvanceDenomiationCommon extends StatefulWidget {
  const AdvanceDenomiationCommon({super.key});

  @override
  State<AdvanceDenomiationCommon> createState() => _AdvanceDenomiationCommonState();
}

class _AdvanceDenomiationCommonState extends State<AdvanceDenomiationCommon> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => DataTable(
                          ...
                          rows:
                              _advancePaymentController.paymentParticulars.value.map((item) {
