...
import 'package:ausales_application/view/widgets/screen_widgets/reports/vendor_wise/vendor_wise_table_header.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class VendorWiseReportScreen extends StatefulWidget {
  const VendorWiseReportScreen({super.key});

  @override
  State<VendorWiseReportScreen> createState() =>
      _VendorWiseReportScreenState();
}

class _VendorWiseReportScreenState
    extends State<VendorWiseReportScreen> {
  final VendorWiseReportController
      _vendorWiseReportController =
        ...
        child: Form(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Obx(() =>PrimaryButton(
                        btnWidth: 150.w,
                        isLoading: _vendorWiseReportController.isExportLoading.value,
                        text: 'Export',
                        onPressed: () {
                          _vendorWiseReportController.exportData(context);
                        }))
                    ],
                  ),
                  SizedBox(
            ...
            Container(
              ...
              child: Stack(
                children: [
                  Obx(() => _vendorWiseReportController
          ...
          ? Column(
              children: [
                ...
                Obx(() => DropdownButton<int>(
                      value: _vendorWiseReportController
                          .itemsPerPage.value,
                      onChanged: (value) {
                        _vendorWiseReportController
                            .itemsPerPage(value);
  ...
  Obx changePage(BuildContext context) {
    return Obx(() => Responsive.isMobile(context)
        ? Column(
            children: [
              Text(
                'Page ${_vendorWiseReportController.page.value} of ${_vendorWiseReportController.totalpages.value}',
                style: TextStyle(
                    fontSize: Responsive.isDesktop(context) ||
                            Responsive.isTablet(context)
                        ? 12.sp
                  ...
                  IconButton(
                      icon: Icon(Icons.arrow_back,
                          size: Responsive.isDesktop(context) ||
                              ...
                              ? 20.sp
                              : 15.sp),
                      onPressed: _vendorWiseReportController
                                  .page.value >
                              1
                          ? () {
                              if (_vendorWiseReportController
                                      .page.value >
                                  1) {
                                _vendorWiseReportController.page(
                                    _vendorWiseReportController
                                            .page.value -
                                        1);
                                _vendorWiseReportController
              ...
              IconButton(
                  icon: Icon(Icons.arrow_back,
                      size: Responsive.isDesktop(context) ||
                          ...
                          : 15.sp),
                  onPressed:
                      _vendorWiseReportController.page.value > 1
                          ? () {
                              if (_vendorWiseReportController
                                      .page.value >
                                  1) {
              ...
              IconButton(
                  icon: Icon(Icons.arrow_forward,
                      size: Responsive.isDesktop(context) ||
                          ...
                          : 15.sp),
                  onPressed:
                      _vendorWiseReportController.page.value <
                              _vendorWiseReportController
                                  .totalpages.value
                          ? () {
                              if (_vendorWiseReportController
